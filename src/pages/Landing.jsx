    ...
    >
      <div className="mt-[30px] flex justify-between mx-[40px]">
        ...
        <div className="right-[40px]">
          <div className="w-[200px] flex space-x-[40px] items-start">
            <span onClick={(e) => gotToWebsite("https://twitter.com/ajyghosh")}>
              <i className="fa fa-twitter text-[#0088cc] text-[40px] cursor-pointer hover:scale-110"></i>
            </span>
            <span
              onClick={(e) =>
                gotToWebsite("https://www.linkedin.com/in/ajyghosh/")
              }
            >
              <i className="fa fa-brands fa-linkedin text-[#0088cc] text-[40px] cursor-pointer hover:scale-110"></i>
            </span>
            <span
              onClick={(e) => gotToWebsite("mailto:help@customgpts.in")}
              className="p-[10px] rounded-full bg-[#d44638] flex items-center group-hover:space-x-2 hover:scale-110"
            >
      ...
      <div className="justfiy-center items-center sm:items-start mt-[30px] text-[50px] sm:absolute sm:left-[80px] lg:left-[200px] sm:top-[270px] md:top-[200px] text-white sm:text-[30px] md:text-[45px] lg:text-[59px] font-[700] flex flex-col space-x-0">
        <div>SHAPING</div>
